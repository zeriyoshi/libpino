...
static inline bool get_asset_path(char *filename, char *path,
                                  size_t path_size) {
...
static inline bool load_file(const char *filename, uint8_t **out_data,
                             size_t *out_size) {
  FILE *file;
  size_t readsize;
  long size;
...
static inline bool save_file(const char *filename, const uint8_t *data,
                             size_t size) {
  FILE *file;
  size_t written;
