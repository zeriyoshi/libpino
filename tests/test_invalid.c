...
void test_endianness(void)
{
    ...
    pino_endianness_memcpy_le2native(&i, &j, sizeof(char), sizeof(char));
    pino_endianness_memcpy_be2native(&i, &j, sizeof(char), sizeof(char));
    pino_endianness_memcpy_native2le(&i, &j, sizeof(char), sizeof(char));
    pino_endianness_memcpy_native2be(&i, &j, sizeof(char), sizeof(char));

    pino_endianness_memcpy_le2native(u + 1, b, 2, 2);
    pino_endianness_memcpy_be2native(u + 1, b, 2, 2);
    pino_endianness_memcpy_native2le(u + 1, b, 2, 2);
    pino_endianness_memcpy_native2be(u + 1, b, 2, 2);
