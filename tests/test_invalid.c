...
void setUp(void) {
  ...
  if (!get_asset_path("pack_invalid_static_fields_size.bin",
                      g_invalid_static_fields_size_path,
                      sizeof(g_invalid_static_fields_size_path)) ||
      !get_asset_path("pack_truncated.bin", g_truncated_path,
                      sizeof(g_truncated_path)) ||
      !get_asset_path("pack_broken.bin", g_broken_path,
                      sizeof(g_broken_path)) ||
      !get_asset_path("pack_handler_missing.bin", g_handler_missing_path,
                      sizeof(g_handler_missing_path))) {
